        ...
        <div className="flex w-full items-center lg:w-1/2">
          <div className="mb-8 max-w-2xl">
            <h1 className="text-4xl font-bold leading-snug tracking-tight text-gray-800 dark:text-white lg:text-4xl lg:leading-tight xl:text-6xl xl:leading-tight">
              The latest and Best Guide to Rednote.
            </h1>
            <p className="py-5 text-xl leading-normal text-gray-500 dark:text-gray-300 lg:text-xl xl:text-2xl">
              Rednote Bar is a platform that helps users from other platforms better integrate into
              Rednote (Xiaohongshu). Friends from TikTok, Instagram, and other platforms are welcome
              to join.
            </p>
            ...
            <div className="flex flex-col items-start space-y-3 sm:flex-row sm:items-center sm:space-x-4 sm:space-y-0">
              <a
                ...
                target="_blank"
                rel="noopener"
                className="rounded-md bg-primary-500 px-8 py-4 text-center text-lg font-medium text-white "
              >
                Sign up for Rednote
              </a>
              {/* <a
